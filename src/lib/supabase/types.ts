...
// Table: whatsapp_messages
//   CREATE UNIQUE INDEX idx_unique_message_per_conversation ON public.whatsapp_messages USING btree (conversation_id, external_message_id) WHERE (external_message_id IS NOT NULL)
